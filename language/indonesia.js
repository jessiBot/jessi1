...
exports.menunya = (salam, pushname, botname) =>{
	return`Hay bro ${pushname} 👋 safe ${salam} , 
I am ${botname}, 🆃his bot is Whatsapp Multi-Device Beta.
...
exports.welcome = () =>{
	return`Don t forget the intro bro
	
╭ Name :
├ Age :
├ 𝖦𝖾𝗇𝖽𝖾𝗋 :
╰❒ obey the group rules, bro ~`
}
exports.leave = () =>{
	return`Well, how come you re out Mentally safe 😣, right bro >.<
Goodbye`
}
exports.source = () =>{
return`*------「 SOURCE CODE 」 ------*
